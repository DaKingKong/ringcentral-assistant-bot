...
function settingsCard(botId, rcUserId, replySetting) {
    ...
    const start = replySetting.outOfOfficeStartDate ? moment(replySetting.outOfOfficeStartDate) : '';
    const end = replySetting.outOfOfficeEndDate ? moment(replySetting.outOfOfficeEndDate) : '';
